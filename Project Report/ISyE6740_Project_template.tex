...
% Plot of Loss and Accuracy on Training Dataset
 \begin{figure}[h!]
 \centering
...
% A Schematic of the Convolutional Neural Network with Dropout
 \begin{figure}[h!]
 \centering
...
% The Plot of Loss and Accuracy on Training Dataset with Dropout
 \begin{figure}[h!]
 \centering
...
% A Schematic of the Convolutional Neural Network with Additional Layers
  \begin{figure}[h!]
 \centering
...
% The Plot of Loss and Accuracy on Training Dataset with Additional layers
 \begin{figure}[h!]
 \centering
